  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="input_dosen.php" class="list-group-item list-group-item-action py-2 ripple active"
 ...
 <table>
  ...
  <tr>
   ...
   <tr>
    <td>Mata Kuliah</td>
    <td>:</td>
    <td> <input type="text" name="Mata Kuliah:" class="form-control"></td>
  </tr>
   <tr>
    <td>Tempat Lahir</td>
    <td>:</td>
    <td> <input type="text" name="Temapat Lahir:" class="form-control"></td>
  </tr>
   <tr>
    <td>Tanggal Lahir</td>
    <td>:</td>
