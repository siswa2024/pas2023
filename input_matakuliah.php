  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        >
        <a href="input_mahasiswa.php" class="list-group-item list-group-item-action py-2 ripple"
          ><i class="fas fa-chart-line fa-fw me-3"></i><span>Input Data Mahasiswa</span></a
        >
        <a href="input_matakuliah.php" class="list-group-item list-group-item-action py-2 ripple active">
...
<main style="margin-top: 58px;">
  ...
  <p><h1 align="center">MATA KULIAH</h1></p>
  <br>
  ...
  <table>
    <tr>
      ...
      <td>:</td>
      <td> <input type="text" name="Nama Mata kuliah:"></td>
    </tr>
      <tr>
      <td>Semester</td>
      <td>:</td>
      ...
      <td>Jumlah SKS</td>
      <td>:</td>
      <td> <input type="text" name="Jumlah SKS:"></td>
    </tr>
      <tr>
      <td>Dosen Pengajar</td>
      <td>:</td>
      <td><input type="text" name="Dosen Pengajar:"></td>
    </tr>
      <tr>
      <td>Kelas</td>
      <td>:</td>
