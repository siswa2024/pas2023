  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        >
        <a href="input_mahasiswa" class="list-group-item list-group-item-action py-2 ripple"
          ><i class="fas fa-chart-line fa-fw me-3"></i><span>Input Data Mahasiswas</span></a
        >
        <a href="input_matakuliah" class="list-group-item list-group-item-action py-2 ripple">
          <i class="fas fa-chart-pie fa-fw me-3"></i><span>Input Data Kuliah</span>
        </a>
        <a href="input_organisasi" class="list-group-item list-group-item-action py-2 ripple"
